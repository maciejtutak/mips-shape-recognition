#################################################################################
#										#
#  Ecoar L3, Author: Maciej Tutak, 262785 					#
#  Task: Determine the shape on the input. 3.7 SET 3				#
#  based on: https://en.wikipedia.org/wiki/BMP_file_format			#
#  USAGE: please insert the absolute path to the file, because MARS simulator	#
#  does not see the files that are not in the same directory as mars.jar	#
#  P.S. number of comments is excessive, but they are only there because  	#
...
input:		.asciiz "/Users/maciejtutak/mips short project/s06-1.bmp"
inputName:	.space	128
